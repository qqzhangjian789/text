...
from data_ccxt.base.errors import NetworkError
from data_ccxt.base.errors import NotSupported
from data_ccxt.base.errors import AuthenticationError
from data_ccxt.base.errors import DDoSProtection
from data_ccxt.base.errors import RequestTimeout
...
from data_ccxt.base.decimal_to_precision import decimal_to_precision
from data_ccxt.base.decimal_to_precision import DECIMAL_PLACES, NO_PADDING, TRUNCATE, ROUND, ROUND_UP, ROUND_DOWN
from data_ccxt.base.decimal_to_precision import number_to_string
...
# ecdsa signing
from data_ccxt.static_dependencies import ecdsa
# eddsa signing
try:
...
class Exchange(object):
    ...
    def __init__(self, config={}):
        ...
        # self.userAgent = {
        #     'User-Agent': 'data_ccxt/' + __version__ + ' (+https://github.com/ccxt/ccxt) Python/' + version
        # }
    ...
    def __repr__(self):
        return 'data_ccxt.' + ('async_support.' if self.asyncio_loop else '') + self.id + '()'
