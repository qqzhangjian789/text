        ...
        return self.deep_extend(super(gopax, self).describe(), {
            ...
            'exceptions': {
                'broad': {
                    ...
                    'ERROR_INVALID_TRADING_PAIR': BadSymbol,  # Unlikely to be triggered, due to data_ccxt.gopax.js implementation
                    ...
                    'ERROR_NO_SUCH_TRADING_PAIR': BadSymbol,  # Unlikely to be triggered, due to data_ccxt.gopax.js implementation
